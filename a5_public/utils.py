...
def pad_sents_char(sents, char_pad_token):
    ...
    for sent in sents:
        ...
        for word in sent:
            ...
            words_padded.append(word_padded)
        if len(words_padded) < max_sent_len:
            words_padded += [char_padded] * (max_sent_len - len(words_padded))
...
def pad_sents(sents, pad_token):
    ...
    for x in sents:
        pad_sent = x + [pad_token]*(max_len-len(x))
